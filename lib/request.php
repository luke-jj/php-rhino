...
/**
 * This class holds all relevant information about the received http request.
 */
...
class Request {
    ...
    private $body;
    // body decoded from json string to php array
    private $json;      
    // mapping of query string parameter names (key) to their values.
    public $query;      
    // mapping of route parameter names (key) to their values.
    public $params;     
